...
scale_factor = 0.5
GUI_Enable = True
VIDEO_URI = '/Users/dcongtinh/Workspace/endless-runner/pose/datatest/Tinh_Test.mov'
fontFace = cv2.FONT_HERSHEY_SIMPLEX
fontScale, thickness = 0.75, 2

model_loaded = load_model(
    "/Users/dcongtinh/Workspace/endless-runner/results/20210324_090942/20210324_090942model.h5")
...
def main():
    ...
    while True:
        ...
        if GUI_Enable:
            ...
            # print('overlay_image', overlay_image.shape)
